...
<tr >
    ...
    <td>
        <select name="field_type[]"
            ...
            <option value="list_single" <?php if($tblcol->field_type == 'list_single'){echo ' selected '; } ?> >List (Single Choice)</option>
            <option value="list_multiple" <?php if($tblcol->field_type == 'list_multiple'){echo ' selected '; } ?> >List (Multi Choice)</option>
    ...
    <td>
        <input type="text" name="input_length[]"
            id="input_length<?php echo $nrecs_form_to_table; ?>"
            class="form-control" 
            value="<?php echo $tblcol->input_length; ?>" 
            style="width:100px;"
            />
    </td>
    <td>
