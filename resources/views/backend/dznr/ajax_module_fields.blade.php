<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <input type="text" name="field_label[]" id="field_label@php echo $nrecs_form_to_table; @endphp" class="form-control" value="@php echo strtoupper(str_replace('_',' ',$tblcol->COLUMN_NAME)); @endphp" />
            </td>
            <td>
                <select name="field_type[]" id="field_type@php echo $nrecs_form_to_table; @endphp" class="form-control">
                    ...
                    <option value="list_single" @php if($tblcol->DATA_TYPE == 'list_single'){echo ' selected '; } @endphp >List (Single Choice)</option>
                    <option value="list_multiple" @php if($tblcol->DATA_TYPE == 'list_multiple'){echo ' selected '; } @endphp >List (Multi Choice)</option>
            ...
            <td>
                <input type="text" name="input_length[]" id="input_length@php echo $nrecs_form_to_table; @endphp" class="form-control" value="@php echo $tblcol->CHARACTER_OCTET_LENGTH; @endphp" style="width:100px;" />
            </td>
            <td>
