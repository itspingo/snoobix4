                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" name="input_length[]" id="input_length@php echo $nrecs_form_to_table; @endphp" class="form-control" value="@php echo $tblcol->input_length; @endphp" style="width:100px;" />
                                                    </td>
                                                    <td>
