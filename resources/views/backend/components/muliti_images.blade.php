	...
	<div class="form-group">
		...
		<input
			...
			<div>
			   @php 
				if(!Empty($data_row)){ 
					$imglist = explode(',',$data_row[0]->$vfldName);
					for($i=0; $i < count($imglist); $i++){
						//echo '<a target="_BLANK" href="https://cartmycar.co.za/home/photo?img='.$imglist[$i].'" >'.$imglist[$i].'</a>';
						 echo '<a target="_BLANK" href="https://cartmycar.co.za/admin/images/'.$imglist[$i].'" >'.$imglist[$i].'</a>';
					}
				}
				@endphp 
			</div> 
