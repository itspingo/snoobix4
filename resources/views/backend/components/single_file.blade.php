			...
			<div>			   
			    @php 
					if(!Empty($data_row)){ 
						...
						echo '<a target="_BLANK" href="https://cartmycar.co.za/admin/files/'.$data_row[0]->$vfldName.'" >'.$data_row[0]->$vfldName.'</a>';
						//echo '<a target="_BLANK" href="https://thetatech.org/demo/cartmycar/admin/laravel/storage/app/uploads/'.$data_row[0]->$vfldName.'" >'.$data_row[0]->$vfldName.'</a>';
