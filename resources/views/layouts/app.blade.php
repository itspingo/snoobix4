                    ...
                    <div class="d-flex">
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a class="dropdown-item" onClick="jascript:exec_logout();" style="cursor:pointer;" ><i class="uil uil-sign-out-alt font-size-18 align-middle me-1 text-muted"></i> <span class="align-middle">Sign out</span></a>
                        ...
                        <form id="frmLogout" name="frmLogout" method="POST" action="{{ route('logout') }}">
                            @csrf
