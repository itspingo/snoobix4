...
class update extends Controller{
    ...
    if($isaved){
        ...
        return redirect('/edit?mid='.$mid.'&rid='.$rid)->with('msg_success','Record is saved successfuly');;
    }else{
        return redirect('/edit?mid='.$mid.'&rid='.$rid)->with('msg_failure','Record is NOT saved successfuly');;
    }                     
