...
if(!function_exists('post_insert_functions')){
    ...
    function post_insert_functions( $postedData){
    ...
    if($row['table_name'] == 'web_users'){
        ...
        if(isset($row['isapproved'])){
            ...
            if($row['isapproved'] == 'Y' && ( $row['hisapproved'] == "" || $row['hisapproved'] == "N") ){
                ...
                $emlbody = "Hi,"."<br>". "Your account has been successfully approved and you now have access to CartMyCar"."<br>"." Regards,CartMyCar";
                ...
                $resp = Http::get('//cartmycar.co.za/home/mail?'.$params);
